...
export default function AdminDashboardScreen({ navigation }) {
  const theme = themes.dark; // O tu lógica de tema
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bgMainDark }]}>
      <View style={styles.content}>
        <Ionicons name="shield-checkmark" size={60} color={theme.accentColor} />
        <Text style={[styles.text, { color: theme.textPrimary }]}>Panel de Administrador</Text>
