            ...
            ejercicios_insert = [
                {
                    ...
                    "peso":             str(ej.get('peso', '') or ''),
                    "grupo_muscular":   ej.get('muscleGroup', '') or day_data.get('muscleGroup', '') or '',
                    "unidad":           (ej.get('unidad') or 'kg'),
                    "notas":            ej.get('notes', ''),
                ...
                'exercises': [
                    {
                        ...
                        'peso':        ej.get('peso', ''),
                        'muscleGroup': ej.get('grupo_muscular', '') or dia.get('grupo_muscular', ''),
